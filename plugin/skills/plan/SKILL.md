...
- Before adding any `card-spec` todo, run `npx ars card list` to see all available built-in and series-scoped cards with their agentHints and live examples. Do not manually scan spec.ts files.
