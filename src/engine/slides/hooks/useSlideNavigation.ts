...
export function useSlideNavigation({
  ...
  const goTo = useCallback(
    (index: number) => {
      ...
      setShowOverview(false); // 選頁後自動關閉 overview
  ...
  }, [next, prev, goToFirst, goToLast, toggleFullscreen, toggleNotes, toggleOverview, isFullscreen, showOverview, onToggleAudio]);
